...
const packageRows = [
  ...
  {
    title: "Spanish MVA leads",
    desc: "We run Spanish-language campaigns written by native Spanish speakers, not generated by AI. The ads sound like a real person because a real person wrote them, and Spanish-speaking people stand behind every campaign. Same exclusivity: one firm per market.",
    note: "Zero AI-written ad copy. No AI slop in front of your future clients.",
    badge: "Human-written",
  },
  {
...
const faq = [
  ...
  {
    question: "Do you sell Spanish MVA leads?",
    answer:
      "Yes. We run MVA campaigns in Spanish, and we do not use AI to write them. Native Spanish speakers write every ad, so it reads like a person talking, not a machine translation. Spanish-speaking accident victims can tell the difference.",
  },
  {
